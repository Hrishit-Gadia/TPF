...
function draw() {
    ...
    fill(Red2, Green3, Blue2);
    circle(37, 75, 70);
    fill(Red2, Green3, Blue2);
    rect(50, 25, 100, 50);
    fill(Red2, Green2, Blue3);
    circle(110, 50, 70);
    fill(Red2, Green1, Blue2);
    rect(120, 50, 100, 50);
    ...
    rect(250, 20, 85, 35);
    fill(Red1, Green2, Blue2);
    circle(390, 50, 70);
    fill(Red1, Green1, Blue1);
    circle(350, 50, 70);
    fill(Red1, Green1, Blue2);
    rect(360, 50, 55, 75);
    fill(Red1, Green2, Blue1);
    rect(400, 30, 55, 55);
    fill(Red2, Green1, Blue1);
    circle(450, 50, 70);
    fill(Red2, Green3, Blue2);
    rect(450, 10, 55, 95);
    ...
    fill(Red5, Green3, Blue3);
    circle(37, 225, 70);//!
    fill(Red2, Green4, Blue2);
    rect(30, 105, 60, 120);
    fill(Red2, Green2, Blue3);
    circle(40, 240, 70);
    fill(Red5, Green1, Blue2);
    rect(75, 250, 50, 70);
    fill(Red2, Green5, Blue1);
    circle(75, 300, 70);
    fill(Red2, Green4, Blue3);
    circle(90, 350, 70);
    fill(Red2, Green5, Blue4);
    rect(250, 420, 135, 75);
